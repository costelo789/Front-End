/**
 * Creating a general template UI for the application 
 * @version 1.0.0
...
//``` CSS properties using in the template
...
const PublicTemplate = connect(
  ...
  //``` Create a left menu list for navigating between pages
  const drawer = (
    <div>
      <div className={classes.toolbar}  >
        <h1 style={{ textAlign: "center", paddingTop: "8%", fontSize: 25 }}>
          iFASTATHANU
      </h1>
      </div>
